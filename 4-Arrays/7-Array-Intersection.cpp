...
of first array matches with the first '2' of the second array. Similarly, the second '2' of the first array matches 
...
int main(){
	...
	while(t--){
		...
		// Comparing and printing if we found a match at the same time updating the second array 
		for(int x = 0; x < n1; x++){
			for(int y = 0; y < n2; y++){
				if(arr1[x] == arr2[y]){
					cout << arr2[y] << " " ;
