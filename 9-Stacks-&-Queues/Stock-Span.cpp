...
int* stockSpan(int *price, int size) {
    /* take a stack and add indices if smaller if greater then remove manage the greatest indice
    and add + 1 to the indice if its the greatest // by doing this we can slove he program in order of n rather than n^2*/

    // create a stack and output array
    stack<int> stk;
    ...
    // iterate and start pushing the indices and poping them if smaller greater respectively
