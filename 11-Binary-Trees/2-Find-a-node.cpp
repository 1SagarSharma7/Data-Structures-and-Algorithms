...
bool isNodePresent(BinaryTreeNode<int> *root, int x) {
	...
	// recur case
	bool leftCondition = isNodePresent(root -> left, x);
	bool rightCondition = isNodePresent(root -> right, x);

	// scal case
	bool smallOutput = x == root -> data ? true : false;
	return leftCondition || rightCondition || smallOutput;
...
int main(){
	...
	bool print = isNodePresent(root, x);
