...
/* I am not gonna code the code for the test case */
...
int main(){
	...
	// Loop and take all the elements
	...
	// Take the element which we have to find
	
	int x;
	cin >> x;
	
	// Loop the array and compare the x with each element in the array // if theres a match print and return or else after the loop print - 1
