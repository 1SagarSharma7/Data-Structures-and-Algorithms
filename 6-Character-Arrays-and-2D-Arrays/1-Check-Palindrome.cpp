...
//	bool flag = true;
	for(int i = 0; i <= len / 2; i++){
		if(str[i] != str[len - i - 1]){
			cout << "false" << endl;		// if its not palindrome
			return;		
		}									// no need of flag .. we could have have couted and return
	}
	cout << "true" << endl;			// if the whole array had been iterated then the value of flag will be true (unchanged)
}
